...
namespace BetterCommerce.Business.Structure.Concrete
{
    public class BusinessService : IBusinessService
    {
        ...
        public BusinessService(IUnitOfWork uow, UserManager<ApplicationUser> userManager,
            ...
            ITokenHelper tokenHelper, RoleManager<ApplicationRole> roleManager, IPasswordHasher<ApplicationUser> passwordHasher, IMemoryCache cache)
        {
            _uow = uow;
        ...
        public IProductService Product => _productService ??= new ProductManager(_uow, _cache);
